<div class="menu-wrap">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tbody><tr>
                <td width="1%" style="white-space: nowrap;">
                    <span class="titleBandLink">Ним</span>
                </td>
                <td>&nbsp;</td>
                <td width="1%" align="center" style="white-space: nowrap;">
                    <span class="titleBandLink" onclick="$('#game-description').show();">Описание</span>
                </td>
                <td>&nbsp;</td>
                <td width="1%" align="center" style="white-space: nowrap;">
                    <span id="gbShow" class="titleBandLink">Вопросы и отзывы</span>
                </td>
                <td>&nbsp;</td>
                <td width="1%" align="right" style="white-space: nowrap;">
                    <a href="/" class="titleBandLink">
                        Перейти на другие игры                    </a>
                </td>
            </tr>
            </tbody></table>
    </div>
    ...
    <div class="menu-buttons menu-buttons__singlegame menu-buttons__top noselect">
        ...
        <a data-value="8" class="mode mode_marienbad active">Мариенбад (1,3,5,7)<span class="counter"></span></a>
        ...
        <a class="button_throw" data-value="5" style="display: none;">Сдаться</a>
